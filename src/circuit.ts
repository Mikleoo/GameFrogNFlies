...
class circuit {
    ...
    constructor(longueurCircuit : number, largeurCircuit : number, nbreTours : number) {
    ...
    public envoie() : void {
      ...
      $.ajax({
        ...
        data: {
          ...
          score: (<HTMLInputElement>document.getElementById('score')!).value,
          date: d,
        },
    ...
    public setCookie(value : data) : void {
